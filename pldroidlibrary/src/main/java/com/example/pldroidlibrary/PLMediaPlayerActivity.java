package com.example.pldroidlibrary;
...
import com.example.pldroidlibrary.widget.ScreenOrientationUtils;
...
public class PLMediaPlayerActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        boolean isLand = ScreenOrientationUtils.isLandscape(this);
        boolean isPort = ScreenOrientationUtils.isPortrait(this);
        if (isLand == true) {
            ScreenOrientationUtils.setPortrait(this);
        }else if (isPort == true){
            super.onBackPressed();
        }
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        // 切换到横屏
        if (ScreenOrientationUtils.isPortrait(this)) {
            ScreenOrientationUtils.setLandscape(this);
        } else {
            ScreenOrientationUtils.setPortrait(this);
        }
